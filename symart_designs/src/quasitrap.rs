...
type V4 = nalgebra::Matrix<f64, na::U4, na::U1, na::ArrayStorage<f64, na::U4, na::U1>>;
type V2 = nalgebra::Matrix<f64, na::U2, na::U1, na::ArrayStorage<f64, na::U2, na::U1>>;

fn zero(_: V4) -> V4 { Vector4::new(0.0, 0.0, 0.0, 0.0) }
fn ident(v: V4) -> V4 { v }
fn invert(v: V4) -> V4 { -v }

fn rot10_1(v: V4) -> V4 { Vector4::new(-v.y, -v.z, -v.w, v.x+v.y+v.z+v.w) }
fn rot10_2(v: V4) -> V4 { Vector4::new(v.z, v.w, -(v.x+v.y+v.z+v.w), v.x) }
fn rot10_3(v: V4) -> V4 { Vector4::new(-v.w, v.x+v.y+v.z+v.w, -v.x, -v.y) }
fn rot10_4(v: V4) -> V4 { Vector4::new(-(v.x+v.y+v.z+v.w), v.x, v.y, v.z) }
fn rot10_5(v: V4) -> V4 { Vector4::new(v.y, v.z, v.w, -(v.x+v.y+v.z+v.w)) }
fn rot10_6(v: V4) -> V4 { Vector4::new(-v.z, -v.w, v.x+v.y+v.z+v.w, -v.x) }
fn rot10_7(v: V4) -> V4 { Vector4::new(v.w, -(v.x+v.y+v.z+v.w), v.x, v.y) }
fn rot10_8(v: V4) -> V4 { Vector4::new(v.x+v.y+v.z+v.w, -v.x, -v.y, -v.z) }

fn flip10_1(v: V4) -> V4 { Vector4::new(v.y, v.w, v.x, v.z) }
fn flip10_2(v: V4) -> V4 { Vector4::new(v.z, v.x, v.w, v.y) }
fn flip10_3(v: V4) -> V4 { Vector4::new(v.w, v.z, v.y, v.x) }

fn flip8_1(v: V4) -> V4 { Vector4::new(v.x, v.w, -v.z, v.y) }
...
fn rot8_4(v: V4) -> V4 { Vector4::new(-v.y,-v.z,-v.w,v.x) }
fn rot8_5(v: V4) -> V4 { Vector4::new(-v.z,-v.w,v.x,v.y) }
fn rot8_6(v: V4) -> V4 { Vector4::new(-v.w,v.x,v.y,v.z) }

fn rot12_1(v: V4) -> V4 { Vector4::new(v.y,v.z,v.w,v.z-v.x) }
fn rot12_2(v: V4) -> V4 { Vector4::new(v.z,v.w,v.z-v.x,v.w-v.y) }
fn rot12_3(v: V4) -> V4 { Vector4::new(v.w,v.z-v.x,v.w-v.y,-v.x) }
fn rot12_4(v: V4) -> V4 { Vector4::new(v.z-v.x,v.w-v.y,-v.x,-v.y) }
fn rot12_5(v: V4) -> V4 { Vector4::new(v.w-v.y,-v.x,-v.y,-v.z) }
fn rot12_6(v: V4) -> V4 { Vector4::new(-v.y,-v.z,-v.w,v.x-v.z) }
fn rot12_7(v: V4) -> V4 { Vector4::new(-v.z,-v.w,v.x-v.z,v.y-v.w) }
fn rot12_8(v: V4) -> V4 { Vector4::new(-v.w,v.x-v.z,v.y-v.w,v.x) }
fn rot12_9(v: V4) -> V4 { Vector4::new(v.x-v.z,v.y-v.w,v.x,v.y) }
fn rot12_10(v: V4) -> V4 { Vector4::new(v.y-v.w,v.x,v.y,v.z) }

static TRANSFORMS_5: [fn(V4) -> V4; 11] = [zero, ident, invert, rot10_1,
    rot10_2, rot10_3, rot10_4, rot10_5, rot10_6, rot10_7, rot10_8];
static TRANSFORMS_8: [fn(V4) -> V4; 9] = [zero, ident, invert, rot8_1,
    rot8_2, rot8_3, rot8_4, rot8_5, rot8_6];
static TRANSFORMS_12: [fn(V4) -> V4; 13] = [ zero, ident, invert, rot12_1, rot12_2,
...
trait TrapRunner {
    ...
    fn run(&self, v2: Vector2<f64>) -> u8 {
        ...
        for _ in 0..self.num_iters() { v = self.iterate(v) }
        let dm = self.dist(v);
...
impl TrapRunner for Trap5Trig {
    ...
    fn new_random<R: Rng + ?Sized>(rng: &mut R) -> Self {
        Self {
            ...
            a1: Slice { slice: &TRANSFORMS_5 }.sample(rng),
    ...
    fn dist(&self, p: V4) -> f64 { dist_5(p) }
...
impl TrapRunner for Trap8Trig {
    ...
    fn new_random<R: Rng + ?Sized>(rng: &mut R) -> Self {
        Self {
            ...
            a1: Slice { slice: &TRANSFORMS_8 }.sample(rng),
            a3: NormalScaled(0.5).sample(rng),
            a4: NormalScaled(0.5).sample(rng),
            a5: NormalScaled(0.5).sample(rng),
            a6: NormalScaled(0.5).sample(rng),
    ...
    fn dist(&self, p: V4) -> f64 { dist_8(p) }
    fn num_iters(&self) -> usize { 15 }
}
...
fn dist_12(v: V4) -> f64 {
    (1.0/6.0) * (v.x.cos() + v.y.cos() + v.z.cos() + v.w.cos()+ (v.x-v.z).cos() + (v.y-v.w).cos())
}
...
impl symart_base::Design for Quasitrap {
    fn name() -> &'static str { "Quasiperiodic Orbit Trap" }
    ...
    fn draw(&self) -> Result<DrawResponse, Box<dyn std::error::Error>> {
        ...
        Ok(DrawResponse { im, sym: symart_base::SymmetryType::None }) 
    }
}
